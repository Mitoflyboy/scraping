...
class AirbnbSpider(scrapy.Spider):
    ...
    # Full scrape - NSW
    start_urls = ['https://www.airbnb.com.au/s/NSW/']
    ...
    custom_settings = {
        ...
        'FEED_URI': '/Users/taj/GitHub/scraping/airbnb/WebData/nsw_extract/airbnb_nsw_extract_' + datetime.datetime.now().strftime("%Y-%m-%d") + '.json' #Used for pipeline 2
    }
    ...
    def parse(self, response):
        ...
        for u in urls:
            ...
            request = scrapy.Request('https://www.airbnb.com.au/'+ u, callback=self.parse_results )
        ...
        if len(url_pages) > 0:
            ...
            nextPageURL = 'https://www.airbnb.com.au/'+ nextPage
    ...
    def parse_results(self, response):
        ...
        p_id1 = response.selector.xpath('//*[@id="site-content"]/div/div[2]/div/div/div/div[3]/div/div[2]/div/div/div').extract_first()
